...
class SortedDay: UITableViewController {
...
//        self.Spinner(Task: 2, tag: 98707)
    ...
    func getData()
    {
//        self.Spinner(Task: 1, tag: 98707)
        
        let parameters =
            [
                "id"          : Global.driverCurrentId,
                "start_week"  : earningData.start_week.replacingOccurrences(of: " ", with: ""),
                "end_week"    : earningData.end_week.replacingOccurrences(of: " ", with: ""),
                "action"      : "one"
            ]
...
//                    self.Spinner(Task: 2, tag: 98706)
            ...
            case .failure(_):
                print("Error in getting Sorted Days")
            }
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "SortedDay", for: indexPath) as! SortedDayCell
        
        
        cell.textSortedDayAll[0].text = self.allData[indexPath.row]["day"]!
        
        let price = String(describing: Double(allData[indexPath.row]["price"]!)!.roundTo(places: 2))
        
        cell.textSortedDayAll[1].text = "$ " + price
